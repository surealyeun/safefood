...
<body>
	...
	<div class="container" id="signUpScreen">
      ...
      <form class="form-signin" method="post" action="User.do">
        ...
        <input type="text" id="inputName" name="inputName" class="form-control" placeholder="이름" required="required">
        <label for="inputEmail" class="sr-only">이메일주소</label>
        <input type="email" id="inputEmail" name="inputEmail" class="form-control" placeholder="이메일주소" required="required">
        <label for="inputPhone" class="sr-only">전화번호</label>
        <input type="tel" id="inputPhone" name="inputPhone" class="form-control" placeholder="전화번호" required="required">
        <label for="inputAddress" class="sr-only">주소</label>
        <input type="text" id="inputAddress" name="inputAddress" class="form-control" placeholder="주소" required="required">
        <fieldset>
