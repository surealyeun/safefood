...
function Crossw1rd(container_id) {
  ...
  this.drawClues = function() {
    ...
    cluediv.append('<h4 class="cluelabel ascrollclue">&nbsp&nbspAcross&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDown</h4>');
    var aol = $('<div class="across scroll-pane ascroll"></div>').appendTo(cluediv);
    var dol = $('<div class="down scroll-pane dscroll"></div>').appendTo(cluediv);
    for (var i=0; i<this.clues.length; i++) {
      var clue = this.clues[i];
      var li;
      if (clue.d=='A') {
  ...
  this.drawControls = function() {
    ...
    var reset = $('<button class="btn_signup">다시하기!</button>').appendTo(div);;
