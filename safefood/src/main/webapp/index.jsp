   	    ...
   	    <div class="bottom_contents" id="bottom_contents">
	   	    <div id="bottom_buttons">
	   	    	 ...
	   	    	 <div id="link_calendar">
	   	    	 	<input type="button" class="btn_calendar" onclick="location.href='main.do'">
	   	    	 </div>
	   	    	 
	   	    	 <div id="link_crosswords">
	   	    	 	<input type="button" class="btn_crosswords" onclick="location.href='main.do'">
	   	    	 </div>
	   	    	 
	   	    	 <div id="link_allergy">
	   	    	 	<input type="button" class="btn_allergy" onclick="location.href='main.do'">
	   	    	 </div>
   	    	 </div>
   	    </div>
